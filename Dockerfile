...
RUN curl -L https://raw.githubusercontent.com/bechtoldt/salt-bootstrap/centos7_docker/bootstrap-salt.sh | sh -s -- -X -Z -P -d -n git v2015.8.0 && mkdir -p /var/log/salt
